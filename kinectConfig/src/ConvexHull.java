...
public class ConvexHull {
	...
	public static void main(String[] args){
		ArrayList<Point2D.Double> k = new ArrayList<Point2D.Double>();
		k.add(new Point2D.Double(10, 0));
		k.add(new Point2D.Double(10, 10));
		k.add(new Point2D.Double(0, 0));
		k.add(new Point2D.Double(0, 10));
		k.add(new Point2D.Double(5, 5));
		k.add(new Point2D.Double(5, 5));
		k.add(new Point2D.Double(5, 7));
		k.add(new Point2D.Double(5, 54));
		k.add(new Point2D.Double(10, 5));
		k.add(new Point2D.Double(1, 0));
		k.add(new Point2D.Double(4, 0));
		System.out.println(getConvexHull(k));
	}
	   ...
	   * distinct points.
	   **/
	  public static ArrayList<Point2D.Double> getConvexHull(ArrayList<Point2D.Double> points) {
