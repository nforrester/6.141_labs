...
\begin{figure}[h]
 \centering
  \includegraphics[width=1.25in]{images/Demo01}
  \includegraphics[width=1.25in]{images/Demo02}
  \includegraphics[width=1.25in]{images/Demo03} \\
  1 \hspace{1.1in} 2 \hspace{1.1in} 3 \\
  \vspace{12pt}
  \includegraphics[width=1.25in]{images/Demo04}
  \includegraphics[width=1.25in]{images/Demo05}
  \includegraphics[width=1.25in]{images/Demo06} \\
  4 \hspace{1.1in} 5 \hspace{1.1in} 6 \\
