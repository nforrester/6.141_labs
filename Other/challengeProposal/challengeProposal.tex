...
In order to successfuly complete the challenge in the allotted time, the robot's motor control system gains should be optimized for the accuracy demands of each state. Motor Velocities will be PID controlled and optimized to either maximize speed or increase accuracy (negative D gain as damper) and will use quadrature encoder feedback. Additionally, visual servoing will be used for precise  and will utilize position feedback from . The gains for each state will be experimented
